...
namespace CustomMLModel
{
    ...
    {
        public const string RetrainFilePath =  @"C:\src\MLNetHelpers\CustomMLModel\wikipedia-detox-250-line-data.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"LoggedIn", @"LoggedIn", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.3270459F,L2Regularization=0.039795443F,LabelColumnName=@"Sentiment",FeatureColumnName=@"Features"}))      
