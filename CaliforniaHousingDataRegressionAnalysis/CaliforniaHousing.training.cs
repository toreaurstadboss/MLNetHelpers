...
namespace CaliforniaHousingDataRegressionAnalysis
{
    ...
    {
        public const string RetrainFilePath =  @"C:\src\MLNetHelpers\CaliforniaHousingDataRegressionAnalysis\housing.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"ocean_proximity", @"ocean_proximity", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=111,NumberOfLeaves=291,FeatureFraction=0.823304F,LabelColumnName=@"median_house_value",FeatureColumnName=@"Features"}));
